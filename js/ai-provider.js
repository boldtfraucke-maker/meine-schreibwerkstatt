...
- "suggestion": nur wenn "positive" false ist und sich ein "excerpt" ergibt: ein konkreter, vollständiger Formulierungsvorschlag für genau diese Stelle - die Autorin kann ihn direkt übernehmen oder als Ausgangspunkt zum eigenen Weiterbearbeiten nutzen. Bei Lob oder ohne konkrete Stelle leer lassen. "suggestion" enthält AUSSCHLIESSLICH den fertigen, einsetzbaren Fließtext selbst (in der Ich-Perspektive/Erzählstimme der Geschichte) - keine Meta-Sätze wie "Du könntest ...", kein einleitendes "z. B.:" und keinen abschließenden Kommentar wie "So bekommt ... mehr Gewicht". Erläuterungen/Einordnungen dazu gehören ausschließlich in "text", niemals in "suggestion".
